...
export const en: UITranslations = {
  ...
  about: {
    ...
    mantraContent:
      'Build things that matter. Being useful by adding real value. And keep learning every day.',
  ...
  projectsPage: {
    ...
    worldBannerTitle: "Marek's Island",
    worldBannerBody: 'Every project became a place to explore on a small interactive island.',
    worldBannerCta: 'Explore the island',
