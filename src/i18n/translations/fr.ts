...
export const fr: UITranslations = {
  ...
  projectsPage: {
    ...
    worldBannerTitle: "L'île de Marek",
    worldBannerBody: 'Chaque projet est devenu un lieu à explorer sur une petite île interactive.',
    worldBannerCta: "Explorer l'île",
