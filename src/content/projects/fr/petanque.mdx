---
title: 'Petanque'
description: 'Un jeu de pétanque en Python pour simuler la 2ème loi de Newton.'
featured: false
techStack: ['Python']
...
Dans le cadre du cours d'informatique en première année de prépa, nous avons eu un projet à réaliser en Python.
L'objectif était de créer un jeu afin de simuler la 2ème loi de Newton.
Mon groupe et moi avons choisi de créer un jeu de pétanque.

<Callout variant="warning">
  C'est mon premier projet en Python et c'est très moche. A l'époque, je ne connaissais même pas
  encore git. Donc soyez indulgents 🤣
</Callout>
