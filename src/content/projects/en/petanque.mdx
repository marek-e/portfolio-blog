---
title: 'Petanque'
description: "A Petanque game in Python to simulate Newton's laws."
featured: false
techStack: ['Python']
...
status: 'completed'
---
In the context of the computer science course in the first year of prep school, we had to develop a project in Python.
The objective was to create a game to simulate Newton's laws.
My group and I chose to create a petanque game.

<Callout variant="warning">
    This is my first project in Python and it's very ugly. At the time, I didn't even know git yet. So be indulgent 🤣
</Callout>
...
<Toggle title="View the Python source code">
