---
name: commit
description: Use only when the user explicitly asks to create atomic Conventional Commits
---
...
<commit-conventions>
Follow the repository conventions in `AGENTS.md` and any commit conventions the user provides.
</commit-conventions>
