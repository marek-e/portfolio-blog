---
name: update-docs
description: Use only when the user explicitly asks to refresh project documentation from the current codebase
---
...
### Step 4: Update shared agent instructions

Ensure `AGENTS.md` reflects current state. `CLAUDE.md` points to the same file:
