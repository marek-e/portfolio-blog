...
description: Use only when the user explicitly asks for a technical implementation strategy from product requirements
---
...
**Feature Description:** Use the feature description or PRD supplied with the skill invocation.
