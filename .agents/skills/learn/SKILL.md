---
name: learn
description: Use only when the user explicitly asks to capture mistakes and durable lessons from the current coding session
---
...
1. **Append to `.agents/mistakes.jsonl`:**
...
- ✅ Appended to .agents/mistakes.jsonl
...
- Suggest the developer run the `validate` skill to confirm
