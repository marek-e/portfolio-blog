---
name: dantotsu
description: Use only when the user explicitly asks for a French Dantotsu root cause analysis after debugging a defect
---
...
```
Use the issue description supplied with the skill invocation or the user's current request.
```
...
1. **Review the conversation history**
   - Identify the specific issue supplied by the user
...
<start-instruction>
Begin by reviewing the conversation history and any issue description supplied by the user. Identify the defect, how it was discovered, and how it was fixed. Then create a comprehensive Dantotsu document in French following the standard.
</start-instruction>
