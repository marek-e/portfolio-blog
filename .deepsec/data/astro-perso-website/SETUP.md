# Agent setup for `astro-perso-website`

This is a deepsec scanning workspace. Project `astro-perso-website` was just registered
(target: `..`). Setup is incomplete — `data/astro-perso-website/INFO.md`
...
2. **Fill in `data/astro-perso-website/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id astro-perso-website
pnpm deepsec process --project-id astro-perso-website
```
