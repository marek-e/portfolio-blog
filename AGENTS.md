...
$validate         # Codex: run format + lint + build checks
/validate         # Claude: run format + lint + build checks
```
...
- [docs/LESSONS.md](docs/LESSONS.md) - Learned mistakes (updated by the `learn` skill)
